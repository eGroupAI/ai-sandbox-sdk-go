...
func (c *Client) CreateAgent(payload map[string]any) (map[string]any, error) {
	return c.json(http.MethodPost, "/agents", payload)
}
func (c *Client) UpdateAgent(agentID int, payload map[string]any) (map[string]any, error) {
	return c.json(http.MethodPut, fmt.Sprintf("/agents/%d", agentID), payload)
}
...
func (c *Client) GetAgentDetail(agentID int) (map[string]any, error) {
	return c.json(http.MethodGet, fmt.Sprintf("/agents/%d", agentID), nil)
}
